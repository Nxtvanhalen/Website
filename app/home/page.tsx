  ...
  '@graph': [
    {
      ...
      description:
        'CLB Consulting is the business entity behind Chris Lee Bergstrom — an AI developer with 20 years in live entertainment, building agentic software for venues, tours, and live events.',
      founder: {
        '@type': 'Person',
