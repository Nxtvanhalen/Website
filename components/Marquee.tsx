...
export default function Marquee() {
  ...
  */
  ...
  const boxStyle =
    'bg-black/80 !border-2 !border-mauve/50 rounded-lg p-4 w-full max-w-[340px] lg:w-[300px] h-[220px] !shadow-[0_0_30px_rgba(147,112,219,0.4)] flex flex-row justify-between items-center gap-4 lg:gap-2 hover:!shadow-[0_0_40px_rgba(147,112,219,0.6)] transition-shadow duration-300';
  ...
  */
  ...
  const titleStyle =
    'text-5xl lg:text-6xl font-heading mb-2 transition-transform duration-200 ease-out hover:-translate-y-0.5 text-center text-white tracking-[0.2em] font-light uppercase';
  ...
  const [_isUserInteracting, setIsUserInteracting] = useState(false);
    ...
    <div className="relative w-full min-h-screen overflow-visible mb-16">
      <div className="marquee-content scroll-fade relative z-10 flex flex-col items-center justify-start min-h-screen px-4 pt-16 md:pt-32 pb-16 text-center text-white">
        ...
        >
          ...
          >
            20 years in live entertainment. Now I help venues and arts organizations operate
          ...
          >
              ...
              <motion.div className={boxStyle} whileHover={{ scale: 1.02 }}>
                ...
                >
                  ...
                  <div className="w-1/2 flex flex-col justify-center items-center">
                    ...
                    <p
                      className="text-[13px] leading-tight text-center mt-1 opacity-80 italic"
                      style={{ color: '#F5F5DC' }}
                    >
                      The whole venue, not just the stage.
                      <br />
                      <strong className="not-italic">Booking</strong>,{' '}
                      <strong className="not-italic">marketing</strong>,{' '}
                      <strong className="not-italic">F&B</strong>,{' '}
                      <strong className="not-italic">security</strong>, and{' '}
                      <strong className="not-italic">safety</strong>.<br />
              ...
              >
                ...
                <div className="w-1/2 flex flex-col justify-center items-center">
                  ...
                  <p
                    ...
                    style={{ color: '#F5F5DC' }}
                  >
                    Protect your venue from <strong className="not-italic">bots</strong> and{' '}
                    <strong className="not-italic">scalpers</strong>.<br />
                    Protect your audience with <strong className="not-italic">accessible</strong>,{' '}
              ...
              >
                ...
                <div className="w-1/2 flex flex-col justify-center items-center">
                  ...
                  <p
                    ...
                    style={{ color: '#F5F5DC' }}
                  >
                    Smart leaders ask for help.
                    <br />
                    <strong className="not-italic">Governance</strong>,{' '}
                    <strong className="not-italic">leadership development</strong>,{' '}
                    <strong className="not-italic">boards</strong>,{' '}
                    <strong className="not-italic">budgets</strong>—<br />
            ...
            >
              ...
              <p
                ...
                style={{ color: '#F5F5DC', fontSize: '14px', fontWeight: 700 }}
              >
          ...
          >
            ...
            >
              ...
              <GalleryImage
                ...
                alt="Pic of reflection of a long road in mirrored glasses, the 1000 mile stare"
              />
              <GalleryImage
                src="/images/gallery/Project1.webp"
                alt="A wide nighttime view of an outdoor concert shows a large crowd gathered behind security barriers, facing a brightly lit main stage. Purple and pink stage lights fill the air with haze, while large video screens on both sides display the performer. A central access walkway leads from the foreground toward the stage, emphasizing the scale and energy of the live music event."
              />
              <GalleryImage
                src="/images/gallery/Project2.webp"
                alt="View from a theater balcony shows a large stage framed by ornate architecture and bathed in blue and purple lighting, with a full band performing beneath a backdrop reading 'The Dandy Warhols.' In the foreground, a digital audio mixing console with colorful illuminated controls and screens is visible, emphasizing the perspective of live sound mixing during a concert in Portland, OR at the Arlene Schnitzer Concert Hall."
              />
              <GalleryImage
                src="/images/gallery/Project3.webp"
