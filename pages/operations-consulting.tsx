  ...
  const painPoints = [
    {
      ...
      description: "Overstaffing, scheduling conflicts, and poor resource allocation draining your payroll budget without delivering proportional value."
    },
    {
      title: "Safety Oversights",
      description: "Compliance gaps and protocol weaknesses that could trigger costly incidents, lawsuits, and production shutdowns."
    },
    {
      title: "Logistics Bottlenecks",
      description: "Supply chain disruptions, equipment delays, and coordination failures that cause expensive downtime and missed deadlines."
    },
    {
      title: "Forecasting Errors",
      description: "Inaccurate projections that leave you short-staffed on sold-out nights or overstaffed on slow ones—margin killers hiding in plain sight."
    }
  ];
  ...
  const solutions = [
    {
      ...
      description: "I review your schedules, settlements, vendor contracts, and crew logs to find where money's leaking."
    },
    {
      title: "Strategic Solutions",
      description: "Proven methodologies and industry insights that address root causes, not just symptoms."
    },
    {
      title: "Risk Prevention",
      description: "I spot the compliance gaps and safety issues before they become insurance claims or lawsuits."
    },
    {
      title: "Measurable Results",
      description: "Cost savings that consistently exceed consulting fees, freeing you to focus on growth and innovation."
    }
  ];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Expert operations consulting for venues and live entertainment. Find hidden losses, fix labor inefficiencies, prevent safety issues, and optimize your bottom line. 20 years of hands-on experience." />
        ...
        <meta property="og:image:alt" content="Operations Consulting - CLB Consulting by Chris Lee Bergstrom" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Expert operations consulting for venues and live entertainment. Comprehensive audits, strategic solutions, risk prevention, and measurable cost savings.",
              "provider": {
                "@type": "Organization",
                ...
                "itemListElement": [
                  {
                    ...
                    "itemOffered": {
                      ...
                      "description": "Review schedules, settlements, vendor contracts, and crew logs to identify cost leaks"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "description": "Proven methodologies addressing root causes of operational inefficiencies"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "description": "Identify compliance gaps and safety issues before they become costly problems"
                    }
                  },
                  {
                    "@type": "Offer",
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="text-center mb-16">
              ...
              >
                Twenty years on stages, in production offices, and on tour buses taught me where money disappears—and how to stop the bleeding. I find the overtime leaks, the vendor overcharges, the scheduling collisions, and the compliance gaps before they become six-figure problems. My fees come out of savings you didn't know you had.
              </motion.p>
            </div>
          </SectionTracker>
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                  ...
                  >
                    ...
                    <div className="text-sm font-body" style={{ color: '#F5F5DC' }}>Typical Budget Overrun</div>
                  ...
                  >
                    ...
                    <div className="text-sm font-body" style={{ color: '#F5F5DC' }}>Of Incidents Are Preventable</div>
                    <div className="text-xs mt-1" style={{ color: '#F5F5DC', opacity: 0.7 }}>Caused by human error and process gaps</div>
                  </motion.div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {painPoints.map((point, index) => (
                  ...
                  >
                    <h3 className="text-xl font-bold mb-3" style={{ color: '#F5F5DC' }}>{point.title}</h3>
                    <p className="text-sm leading-relaxed" style={{ color: '#F5F5DC', opacity: 0.85 }}>{point.description}</p>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            <div className="mb-16">
              ...
              >
                ...
                <p className="text-base font-body leading-relaxed max-w-3xl mx-auto" style={{ color: '#F5F5DC' }}>
                  I don't audit from a conference room. I walk your load-ins, sit in your production meetings, and review your settlements line by line. I've seen how costs hide in crew overtime, vendor markups, and scheduling gaps that nobody's watching. That's where I focus.
                </p>
              </motion.div>
            </div>
          </SectionTracker>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {solutions.map((solution, index) => (
                  <motion.div
                    ...
                    whileHover={{ scale: 1.02 }}
                  >
                    <h3 className="text-xl font-bold mb-3" style={{ color: '#F5F5DC' }}>{solution.title}</h3>
                    <p className="text-sm leading-relaxed" style={{ color: '#F5F5DC', opacity: 0.85 }}>{solution.description}</p>
                  </motion.div>
                ))}
              </div>
            </div>
